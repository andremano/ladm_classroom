...
select s.sunit_id, s.area_m2, s.geometry, r.id as right_id, r.type as type, r.share, p.party_id, p.name, p."role", p.type, r."start" as starting_Date, AsText(s.geom)  as geom
